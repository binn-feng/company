...
@RestController
@AllArgsConstructor
@Api(value = "QuoteOpportunitiesSelfController", tags = "详细报价表-商机自研硬件小记表")
...
public class QuoteOpportunitiesSelfController extends BaseController
{
     ...
     * 查询报价系统-商机自研硬件小记列表
     */
    @ApiOperation(value = "查询报价系统-商机自研硬件小记列表", notes = "查询报价系统-商机自研硬件小记列表")
     ...
     * 导出报价系统-商机自研硬件小记列表
     */
    @ApiOperation(value = "导出报价系统-商机自研硬件小记列表", notes = "导出报价系统-商机自研硬件小记列表")
     ...
     * 获取报价系统-商机自研硬件小记详细信息
     */
    @ApiOperation(value = "获取报价系统-商机自研硬件小记详细信息", notes = "获取报价系统-商机自研硬件小记详细信息")
     ...
     * 新增报价系统-商机自研硬件小记
     */
    @ApiOperation(value = "新增报价系统-商机自研硬件小记", notes = "新增报价系统-商机自研硬件小记")
     ...
     * 修改报价系统-商机自研硬件小记
     */
    @ApiOperation(value = "修改报价系统-商机自研硬件小记", notes = "修改报价系统-商机自研硬件小记")
     ...
     * 删除报价系统-商机自研硬件小记
     */
    @ApiOperation(value = "删除报价系统-商机自研硬件小记", notes = "删除报价系统-商机自研硬件小记")
