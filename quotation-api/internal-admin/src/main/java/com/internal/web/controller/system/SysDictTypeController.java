...
import com.internal.common.core.domain.entity.SysDictType;
 ...
 */
@RestController
@Api(value = "SysDictTypeController", tags = "数据字典类型信息")
...
public class SysDictTypeController extends BaseController
{
    ...
    @GetMapping("/list")
    @ApiOperation(value = "获取数据字典类型列表", notes = "获取数据字典类型列表")
    ...
    @PostMapping("/export")
    @ApiOperation(value = "导出数据字典列表", notes = "导出数据字典列表")
