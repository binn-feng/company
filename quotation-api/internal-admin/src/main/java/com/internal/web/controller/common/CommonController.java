...
@Api(value = "CommonController", tags = "通用请求处理")
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = InternalConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(@RequestPart("file") MultipartFile file) throws Exception
    {
        try
        {
            ...
            // 获取后缀
            ajax.put("suffix", FileUtils.getFileExtension(fileName));
            return ajax;
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = InternalConfig.getProfile();
            // 数据库资源地址
