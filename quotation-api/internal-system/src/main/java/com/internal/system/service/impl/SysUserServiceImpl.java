...
import com.internal.common.constant.UserConstants;
...
import com.internal.common.utils.bean.BeanValidators;
import com.internal.common.utils.spring.SpringUtils;
import com.internal.system.domain.SysPost;
import com.internal.system.domain.SysUserPost;
import com.internal.system.domain.SysUserRole;
import com.internal.system.mapper.SysPostMapper;
import com.internal.system.mapper.SysRoleMapper;
import com.internal.system.mapper.SysUserMapper;
import com.internal.system.mapper.SysUserPostMapper;
import com.internal.system.mapper.SysUserRoleMapper;
import com.internal.system.service.ISysConfigService;
import com.internal.system.service.ISysDeptService;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    {
        if (!CollUtil.isNotEmpty(roleMapper.selectAdminByUserId(SecurityUtils.getUserId())))
        {
    ...
    @Override
    public List<SysUser> selectRoleUserList(Long roleId) {
        return userMapper.selectRoleUserList(roleId);
    }

    @Override
    public List<SysRole> isSupport(Long userId) {
